...
%union {
        ...
        ::foundry::parse::cst::components_1_elem *components_1_elem;
        ::foundry::parse::cst::components_1_list *components_1_list;
}
%type<start> start;
...
components: /*-components-*/ components_1_list { $$ = new ::foundry::parse::cst::components($1); };
...
components_1_elem: /*-components_1_elem-*/ component repetition_qualifier { $$ = new ::foundry::parse::cst::components_1_elem($1, $2); };
components_1_list: /*-components_1_chain-*/ components_1_elem components_1_list { $$ = new ::foundry::parse::cst::components_1_chain($1, $2); } | /*-end_of_components_1-*/ { $$ = new ::foundry::parse::cst::end_of_components_1(); };
